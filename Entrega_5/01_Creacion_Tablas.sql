...
En este archivo en particular, se crea la base de datos, el esquema y las tablas, con sus constraints correspondientes
...
create table gestion.Prorrateo(
    ...
    monto_ordinarias DECIMAL(12,2),
    monto_extraordinarias DECIMAL(12,2),
