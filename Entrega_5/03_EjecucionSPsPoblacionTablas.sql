...
EXEC gestion.sp_importar_consorcios
     @pathConsorcios = N'C:\Users\Usuario\Desktop\bbdda-comision025600-grupo08\Entrega_5\Consorcio\datos-varios-consorcios.csv',
     @pathProveedores = N'C:\Users\Usuario\Desktop\bbdda-comision025600-grupo08\Entrega_5\Consorcio\datos-varios-proveedores.csv';

-- Unidad_Funcional
EXEC gestion.sp_importar_unidades_funcionales
     @path = N'C:\Users\Usuario\Desktop\bbdda-comision025600-grupo08\Entrega_5\Consorcio/UF por consorcio.txt'

-- Persona
-- Unidad_Funcional_Persona
-- Cuenta_Bancaria_Asociada_UF
EXEC gestion.sp_importar_personas
     @pathPersonasDatos = N'C:\Users\Usuario\Desktop\bbdda-comision025600-grupo08\Entrega_5\Consorcio\Inquilino-propietarios-datos.csv',
     @pathPersonasUF = N'C:\Users\Usuario\Desktop\bbdda-comision025600-grupo08\Entrega_5\Consorcio\Inquilino-propietarios-UF.csv';

-- Pago
EXEC gestion.sp_importar_pagos
     @path = N'C:\Users\Usuario\Desktop\bbdda-comision025600-grupo08\Entrega_5\Consorcio/pagos_consorcios.csv';

-- Tipo_Gasto y Proveedor
EXEC gestion.sp_importar_tipos_gastos_y_proveedores
     @path =  N'C:\Users\Usuario\Desktop\bbdda-comision025600-grupo08\Entrega_5\Consorcio/datos-varios-proveedores.csv';

-- Gasto
DECLARE @json NVARCHAR(MAX)
SELECT @json = BulkColumn FROM OPENROWSET(BULK 'C:\Users\Usuario\Desktop\bbdda-comision025600-grupo08\Entrega_5\Consorcio/Servicios.Servicios.json', SINGLE_CLOB) AS jsonn
--print(@json)
...
/* EJECUCIONES ORIGINALES DE LAS SP
-- Tipo_Documento
EXEC gestion.sp_importar_tipos_documentos;
