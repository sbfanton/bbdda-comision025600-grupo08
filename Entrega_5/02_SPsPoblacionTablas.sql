...
BEGIN
    ...
    -- 1️⃣ Crear tabla temporal para el CSV
    IF OBJECT_ID('tempdb..#tmp_personas') IS NOT NULL DROP TABLE #tmp_personas;
    ...
    -- 2️⃣ Obtener listas numeradas de personas y unidades
    ;WITH personas_ordenadas AS (
        SELECT 
            p.nro_doc,
            p.id_tipo_documento,
            CASE WHEN t.inquilino = '1' THEN 1 ELSE 0 END AS es_inquilino,
